 ...
 * @version  V1.03
 * @date     07. October 2009 modifié Bigonoff 2014-12 -> Erreur de valeur FLASHCFG
 * @modification : Bigonoff 2015/02/06 : 
 *                 Valeur de FLASHCFG_Val passée de 0x4000 à 0x403A pour tenir
 *                 compte de la valeur réelle du quartz de l'ARM (12MHz->100Mhz)
 *
 * @note
